...
| **K18-2** | The activity layer — **design VETTED & FINAL** (`k18-2-design-draft.md`): AR-form BKAR at unit scale (finite algebraic identity; Schur-product PSD); **NO small/large-field split** — Hölder + pphi2's existing Nelson per-block bounds + Wick moments; adjacent-block lines in integrated form (Cluster-B estimate class); λ₀ a-uniform. Remaining new content: the AR forest identity + activity assembly + KP row-sum verification. | ★★–★★★, Fable-led | 2–4 wk |
