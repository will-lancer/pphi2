...
| `#print axioms` generator | [`audit/axiom_report.lean`](axiom_report.lean) | Targets the five `formalization.yaml` main results plus 105 regression targets, 110 unique targets in total. |
