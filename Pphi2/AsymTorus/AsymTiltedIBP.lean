...
Algebraic derivatives of the interacting source weight in field coordinates,
needed before a finite-dimensional integration-by-parts identity can start.
No integration-by-parts statement is asserted here.  Wick polynomial
derivatives live in `Pphi2.WickOrdering.WickDerivative`.
-/
